...
postingRouter.post('/filter/paginate', async (req, res) => {
  try {
...
postingRouter.post('/filter/count', async (req, res) => {
  try {
    res.json({
...
postingRouter.get('/:postingId', async (req, res) => {
  try {
...
postingRouter.delete('/:postingId', async (req, res) => {
  try {
    let posting = await Posting.findById(req.params.postingId)
      .lean();
